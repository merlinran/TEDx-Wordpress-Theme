	...
	<div class="row">
		...
		<?php if ($i%3 == 0) { echo '<ul class="row clearfix new">'; } ?>
			<li class="four columns speaker">
				...
				<span><?php echo get_post_meta($post->ID, '_tedxhongyadong_speaker_jobposition_value', true) ?><br /> <em><?php echo get_post_meta($post->ID, '_tedxhongyadong_speaker_employer_value', true) ?></em></span></p>
				
				<p><?php new_excerpt(300); ?></p>
				
				<p><a href="<?php the_permalink(); ?>" class="readMore" >Read <?php echo get_post_meta($post->ID, '_tedxhongyadong_speaker_firstname_value', true) ?>'s Bio</a></p>
