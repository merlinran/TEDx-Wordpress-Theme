			...
			<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<div class="row">
					...
					<aside class=" four columns speakerDetails">
						...
						<?php 
						$speaker_twitterID = get_post_meta($post->ID, '_tedxhongyadong_speaker_twitterID_value', true);
						$speaker_email = get_post_meta($post->ID, '_tedxhongyadong_speaker_email_value', true);
						$speaker_website = get_post_meta($post->ID, '_tedxhongyadong_speaker_website_value', true);
						if ($speaker_twitterID) : ?>
    						<p><strong>新浪微博:</strong> <a href="http://weibo.com/<?php echo $speaker_twitterID ?>"> <?php echo $speaker_twitterID ?></a><br />
						<?php endif; ?>
