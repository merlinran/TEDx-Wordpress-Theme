...
add_action( 'after_setup_theme', 'tedxhongyadong_setup' );

// Custom Sidebar
// http://codex.wordpress.org/Function_Reference/register_sidebar

function tedxhongyadong_register_sidebars() {
...
add_action('widgets_init', 'tedxhongyadong_register_sidebars');
...
// Add TEDxHongyadong logo and redirect link
...
function custom_menu_order($menu_ord){
	...
	return array(
		'index.php',
		'edit.php',
		'edit.php?post_type=tedxhongyadong_speaker',
		'edit.php?post_type=tedxhongyadong_committee',
...
function create_year_taxonomy() {
	$labels_year = array(
  	...
  	register_taxonomy('tedxhongyadongYear','speakers',array(
    	'hierarchical' => false,
    	'labels' => $labels_year,
...
$speaker_details = array(
	...
	array(
		'label' => '新浪微博 Username',
		'desc' => 'Please add the speakers 新浪微博 username.',
...
$committee_details = array(
	...
	array(
		'label' => '新浪微博',
		'desc' => 'Please add the committee members 新浪微博 handle.',
